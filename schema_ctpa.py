...
for key, words in LOBE_WORDS.items():
    ...
    FIELD_DEFINITIONS[f"pe_segmental_{key}"] = f"embolus in a segmental artery or segmental branch of the {words} (the lobe must be named by the report, directly or as 'both lower lobes', 'bilateral lower' or 'all lobes')"
